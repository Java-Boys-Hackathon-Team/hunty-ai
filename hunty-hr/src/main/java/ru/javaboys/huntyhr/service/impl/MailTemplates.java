            ...
            <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.5;">
              <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <table style="width:100%%; border-collapse: collapse; margin: 15px 0;">
                  ...
                  <tr><td><b>⏳ Ориентировочная длительность:</b></td><td>60 минут</td></tr>
                </table>
            
                <p><b>🔗 Ссылка на встречу:</b> <a href="{{URL}}" style="color:#1a73e8;">Встреча</a></p>
    ...
    private static final String INTERVIEW_NOTIFICATION = """
            ...
            <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.5;">
              <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p><b>🔗 Присоединиться:</b> <a href="{{URL}}" style="color:#1a73e8;">Встреча</a></p>
